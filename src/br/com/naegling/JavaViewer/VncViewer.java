...
public class VncViewer extends java.applet.Applet implements WindowListener, Runnable{
	public VncViewer() {
	}
	...
	boolean inSeparateFrame = false;
	  ...
	  //Naegling FIX
	  /**
	   * Setter for inAnApplet Option
	   */
	  public void setInAnApplet(boolean b){
		  inAnApplet=b;
	  }
	  
	  //Naegling FIX
	  /** 
	   * Setter for inSeparateFrame Option
	   */
	  public void setInSeparateFrame(boolean b){
		inSeparateFrame=b;  
	  }
